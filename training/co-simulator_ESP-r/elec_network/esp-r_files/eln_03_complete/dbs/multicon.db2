...
# based on materials db ../dbs/materials.db1.a
   26     # no of composites 
...
# mat ref thickness (m) mat descr & air gap R
  107    0.0130  gypsum plasterboard : Gypsum plasterboard (generic)
    0    0.0500  air  0.170 0.170 0.170
...
# mat ref thickness (m) mat descr & air gap R
  243    0.0030  clear float : 4mm clear float glass with optics from UK national method
  324    0.0010  Silicium : PV material
  162    0.0120  roofing felt : Roofing felt
   21    0.0500  light mix concrete : Light mix concrete
    0    0.0500  air  0.170 0.170 0.170
  151    0.0080  ceiling (plaster) : Ceiling (plaster)
